...
import { Check, ArrowRight, Lightbulb, Search, Flame, Snowflake, Droplets, Filter, Wrench, LucideIcon } from "lucide-react";
...
export const icons: Record<Service["slug"], LucideIcon> = {
...
export const colorClasses: Record<Service["color"], { bg: string; text: string }> = {
...
export function ServiceDetailSection({
  ...
  return (
    <section id={id} className={`scroll-mt-36 py-14 sm:py-20 ${bgClassName}`}>
      <Container>
